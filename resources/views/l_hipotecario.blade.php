...
<section class="home-section home-1">
    <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2>Líneas de negocio - Hipotecario</h2>
                </div>
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_presentaciones" class="" id="" base="">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/l_hipotecario_materiales_publicitarios_comunicacion" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/material-publicitario_hipotecario.jpg);"></div>
                            <p class="text-center">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/l_hipotecario_kit_bienvenida" class="" id="" base="">
                   ...
                   <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_kit_cliente_final" class="" id="" base="">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/l_hipotecario_redes_sociales" class="" id="" base="">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_fotos_promocionales" class="" id="" base="">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_videos_promocionales" class="" id="" base="">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_stickers" class="" id="" base="">
