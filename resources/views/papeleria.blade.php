    ...
    <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/corporativa_papeleria_hoja_membretada" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/Hoja_membretada.jpg);"></div>
                            <p class="text-center">
                                Hoja membretada
                            </p>
                        </a>
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/corporativa_papeleria_plantilla_de_presentacion" class="" id="" base="">
