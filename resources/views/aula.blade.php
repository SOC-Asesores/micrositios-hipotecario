...
<section class="home-section home-1 home-home">
    <div class="container">
            <div class="row all">
                <div class="col-12">
                    <h2>Próximos eventos - Aula</h2>
                </div>
                    <!--<div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_eventos_proximos_eventos_aula_mayo" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/eventos.jpg);"></div>
                            <p class="text-center">
                                Mayo
                            </p>
                        </a>
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_eventos_proximos_eventos_aula_julio" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/eventos.jpg);"></div>
                            <p class="text-center">
                                Julio
                            </p>
