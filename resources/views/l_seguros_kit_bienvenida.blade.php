    ...
    <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_seguros_plantillas_redes_sociales" class="" id="" base="">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_seguros_carpeta_informativa" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/fondos-de-pantalla.jpg);"></div>
                            <p class="text-center">
                                Carpeta informativa
                            </p>
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_seguros_posters" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/fondos-de-pantalla.jpg);"></div>
                            <p class="text-center">
                                Posters
                            </p>
