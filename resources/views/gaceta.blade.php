    ...
    <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/gaceta_hipotecario" class="" id="" base="">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/gaceta_empresarial" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/gaceta.jpg);"></div>
                            <p class="text-center">
                                Empresarial
                            </p>
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/gaceta_seguros" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/gaceta.jpg);"></div>
                            <p class="text-center">
                                Seguros y finanzas
                            </p>
