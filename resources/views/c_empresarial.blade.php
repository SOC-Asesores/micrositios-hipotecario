...
<section class="home-section home-1">
    <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2>Contenido de difusión - Empresarial</h2>
                </div>
                    <!--<div class="col-md-4">
                        <a href="{{url('/')}}/categoria/C_empresarial_perfilador_broker" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/perfilador-broker.jpg);"></div>
                            <p class="text-center">
                                Perfilador - Broker
                            </p>
                        </a>
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/C_empresarial_perfilador_broker" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/perfilador-empresas.jpg);"></div>
                            <p class="text-center">
                                Perfilador - Empresas
                            </p>
                        </a>
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/C_empresarial_networking" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/networking.jpg);"></div>
                            <p class="text-center">
                                Networking
                            </p>
                        </a>
