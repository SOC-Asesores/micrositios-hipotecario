...
<section class="home-section home-1">
    <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2>Materiales Publicitarios y de Comunicación</h2>
                </div>
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_materiales_asesoria" class="" id="" base="">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_materiales_firma" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/logos.png);"></div>
                            <p class="text-center">
                                Firma
                            </p>
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_materiales_socios" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/logos.png);"></div>
                            <p class="text-center">
                                Socios de negocio
                            </p>
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_materiales_servicio" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/logos.png);"></div>
                            <p class="text-center">
                                Servicios
                            </p>
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_materiales_productos" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/logos.png);"></div>
                            <p class="text-center">
                                Productos
                            </p>
