    ...
    <div class="container">
            <div class="row all">
                <div class="col-12">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_eventos_fotos_aula_soc" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/fotos.jpg);"></div>
                            <p class="text-center">
                                Aula SOC
                            </p>
                        </a>
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_eventos_fotos_convenccion" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/fotos.jpg);"></div>
                            <p class="text-center">
                                Convención
                            </p>
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_eventos_fotos_lideres" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/fotos.jpg);"></div>
                            <p class="text-center">
                                Líderes
                            </p>
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/l_eventos_fotos_workshop" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/fotos.jpg);"></div>
                            <p class="text-center">
                                Workshop
                            </p>
