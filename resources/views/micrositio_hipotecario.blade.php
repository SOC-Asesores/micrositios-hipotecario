                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                            ...
                            @endif
                                ...
                                @if ($registro->logo != null)
                                    <img src="{{url('https://socasesores.com/micrositios/img/brokers')}}/{{$registro->logo}}" class="d-inline-block align-top ml-0" style="border-right: 0px; max-width: 200px" alt="">
                                @else
                                   ...
                                   @if($registro->url == "b-experting")
                                    ...
                                    align-top" alt=""> <span style="text-transform: none;">b-experting</span>
                    ...
                    <div class="container">
                        ...
                        <div class="row align-items-center d-none d-lg-flex">
                            ...
                            <div class="col-lg-12 pasos info_1">
                                <div class="row">
                                    <div class="col-12">
                                        @if($registro->cotizador)
                                            <iframe  style="width: 100%; height: 605px; border: 0;" scrolling="yes" src="{{ $registro->cotizador }}" class="comparadorsocIframe"></iframe>
                                        @else
