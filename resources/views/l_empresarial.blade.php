...
<section class="home-section home-1">
    <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2>Líneas de negocio - Empresarial</h2>
                </div>
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_empresarial_presentaciones" class="" id="" base="">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/l_empresarial_materiales_publicitarios_comunicacion" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/material-publicitario_empresarial.jpg);"></div>
                            <p class="text-center">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_empresarial_kit_cliente_final" class="" id="" base="">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/l_empresarial_kit_bienvenida" class="" id="" base="">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/l_empresarial_redes_sociales" class="" id="" base="">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_empresarial_stickers" class="" id="" base="">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_empresarial_fotos_promocionales" class="" id="" base="">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_empresarial_videos_promocionales" class="" id="" base="">
