                    ...
                    <div class="row justify-content-center">
                                    @if($registro->productos_hipotecario != null)
                                        <div class="col-md-3 col-6 mb-4">
                                            <div class="content-button" style="background: #4ED176; border: 1px solid #4ED176; color: #fff;">
                                                <a href="" target="_blank" id="but-hipotecario">
                                                <p style="color: #fff;">Crédito hipotecario</p>
                                            </a>
                                            </div>
                                        </div>
                                    @else
                                    ...
                                    @if($registro->productos_empresarial != null)
                                        <div class="col-md-3 col-6 mb-4">
                                            <div class="content-button" style="background: #4ED176; border: 1px solid #4ED176; color: #fff;">
                                                ...
                                                <p style="color: #fff;">Crédito empresarial</p>
                                            </a>
                                            </div>
                                        </div>
                                    @else
                                    ...
                                    @if($registro->productos_otros != null)
                                       <div class="col-md-3 col-6 mb-4">
                                            <div class="content-button" style="background: #4ED176; border: 1px solid #4ED176; color: #fff;">
                                                ...
                                                <p style="color: #fff;">Crédito de auto</p>
                                            </a>
                                            </div>
                                        </div>
                                    @else
        ...
        @else
            <section>
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <p class="mb-4 pb-4 text-left" style="font-size: 1.5rem; margin-top: 2rem;">Te asesoramos profesionalmente en seguros de vida, fondos de ahorro e inversión, gastos médicos mayores, autos y daños con las mejores aseguradoras de México.</p>
                            </div>
                        </div>
                    </div>
            </section>
