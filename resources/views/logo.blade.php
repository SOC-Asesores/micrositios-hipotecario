    ...
    <div class="container">
            <div class="row all">
                <div class="col-12">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/corporativa_logo_soc" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/logos.png);"></div>
                            <p class="text-center">
                                SOC
                            </p>
                        </a>
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/corporativa_logo_hipotecario" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/Logo-hipotecario.jpg);"></div>
                            <p class="text-center">
                                Hipotecario
                            </p>
                        </a>
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/corporativa_logo_empresarial" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/Logo-empresarial.jpg);"></div>
                            <p class="text-center">
                                Empresarial
                            </p>
                        </a>
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/corporativa_logo_seguros" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/Logo-seguros.jpg);"></div>
                            <p class="text-center">
                                Seguros y Finanzas
                            </p>
                        </a>
