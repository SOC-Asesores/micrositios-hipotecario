    ...
    <div class="container">
            <div class="row all">
                <div class="col-12">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_eventos_videos_convenccion_2019" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/video.jpg);"></div>
                            <p class="text-center">
                                Convención 2019
                            </p>
                        </a>
                    ...
                    <!--<div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_eventos_videos_workshop" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/video.jpg);"></div>
                            <p class="text-center">
                                Workshop
                            </p>
