    ...
    <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_plantillas_redes_sociales" class="" id="" base="">
                    ...
                    <!--<div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_efemerides" class="" id="" base="">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_fondos_de_pantalla" class="" id="" base="">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_carpeta_informativa" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/fondos-de-pantalla.jpg);"></div>
                            <p class="text-center">
                                Carpeta informativa
                            </p>
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_botones" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/fondos-de-pantalla.jpg);"></div>
                            <p class="text-center">
                                Botones para web
                            </p>
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_posters" class="" id="" base="">
                            <div class="content-registro" style="background-image: url({{ url('img') }}/fondos-de-pantalla.jpg);"></div>
                            <p class="text-center">
                                Posters
                            </p>
                    ...
                    <!--<div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_firma_electronica" class="" id="" base="">
                    ...
                    <div class="col-md-4">
                        <a href="{{url('/')}}/categoria/l_hipotecario_tarjeta_presentacion_digital" class="" id="" base="">
